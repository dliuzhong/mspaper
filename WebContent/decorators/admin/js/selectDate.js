...
document.write("<input name='cbtime' style='text-align:left;' id='DS_"+this.inputName+"' size='10' value='"+this.year+"-"+((this.month<10)?"0"+this.month:this.month) +"-"+((this.date<10)?"0"+this.date:this.date)+"' title='双击可进行编缉' ondblclick='this.readOnly=false;this.focus()' onblur='this.readOnly=true' readonly>");
document.write("<button style='width:60px;height:20px;font-size:13px;margin:1px;border:1px solid #A4B3C8;background-color:#DFE7EF;' type=button onclick=this.nextSibling.style.display='block' onfocus=this.blur()>选择日期</button>");
